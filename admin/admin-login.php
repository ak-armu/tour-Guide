			...
			<div class="container">
				...
				<div class="justify-content-end collapse navbar-collapse" id="sndp3">
					<ul class="navbar-nav ml-auto p-2">
	                    ...
	                    <li class="nav-item ms-4"><a class="nav-link text-white" href="admin-login.php">Admin</a></li>
	                    <li class="nav-item ms-4"><a class="nav-link text-white" href="/Tourist-Guide/user-login.php">User</a></li>
	                    <li class="nav-item ms-4"><a class="nav-link text-white" href="/Tourist-Guide/register-form.php">Register</a></li>
					</ul>
				</div>
			</div>
		</nav>
